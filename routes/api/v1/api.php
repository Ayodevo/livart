...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::post('fcm-subscribe-to-topic', 'CustomerController@fcm_subscribe_to_topic');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('new-arrival', 'ProductController@get_new_arrival_products');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('featured', 'CategoryController@get_featured_category');
    });
    ...
    Route::get('flash-sale', [FlashSaleController::class, 'get_flash_sale']);
