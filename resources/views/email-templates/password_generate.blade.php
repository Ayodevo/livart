...
<head>
    ...
    <title>{{ translate('Password Received') }}</title>
    <style>
        body {
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                ...
                <tr>
                    <td align="left" valign="top" colspan="2" style="border-bottom: 1px solid #CCCCCC; padding: 20px 0 10px 0;">
                        <span style="font-size: 18px; font-weight: normal;">{{ translate('Password Received') }}</span>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            {{ translate('Thank you for registering with us.') }}
                            <br/><br/>
                            {{ translate('Your password is') }} :
                            <h3 style="font-weight: 1000">{{ $password }}</h3>
                            <br/><br/>
                            {{ translate('We recommend that you keep your password secure and not share it with anyone. If you feel your password has been compromised, you can change it by going to your account settings.') }}
                            <br/><br/>
                            {{ translate('If you need help or have any questions, feel free to contact us.') }}
                            <br/><br/>
