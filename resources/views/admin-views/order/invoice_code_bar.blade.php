                            ...
                            @if($detail->product_details != null)
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <center>
                                          @php(  $barcode = (new Picqer\Barcode\BarcodeGeneratorHTML())->getBarcode($product['codebar'], Picqer\Barcode\BarcodeGeneratorHTML::TYPE_CODE_128))
                                            <div class="print-only">
                                                <img src="{{ asset('public/assets/admin/img/barcode.png') }}">
                                            </div>
                                        </center>
                                    </td>
...
<script>
    ...
    // Call the printBarcode function when the page is loaded
