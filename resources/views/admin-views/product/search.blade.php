                        ...
                        <div class="row align-items-end gy-3 gx-2">
                            ...
                            <div class="col-sm-6 col-md-5">
                                <div>
                                    ...
                                    <input type="number"  name="min"  class="js-flatpickr form-control flatpickr-custom min-h-40px" placeholder="100" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4 mt-2 mt-sm-0">
                                <div>
                                    <label for="to_date">{{translate('Max Price')}}</label>
                                    <input type="number"  name="max"  class="js-flatpickr form-control flatpickr-custom min-h-40px" placeholder="200" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3 mt-2 mt-sm-0 __btn-row">
                                <a href="" id="" class="btn w-100 btn--reset min-h-45px">{{translate('clear')}}</a>
                            ...
                            <div class="row gy-2 align-items-center">
                                <div class="col-lg-4 col-sm-8 col-md-6">
                                    ...
                                    <script>
                                        ...
                                        orderSelect.addEventListener('change', function() {
                                            if (this.value === 'all') {
                                                window.location.href = 'http://localhost/backend/admin/product/list'; // Redirige vers la route spécifiée
                                            }
                                        });
                                        ...
                                        <td>
                                            ...
                                            @if($product['total_stock'] < 5)
                                                <div class="alert alert-danger stock-alert" role="alert" data-toggle="modal" data-target="#stockModal{{$product->id}}">
                                                    Stock faible: {{$product['total_stock']}}
                                                </div>
