    ...
    <div class="content container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="mb-0 mt-2">{{\App\CentralLogics\translate('* By turning on maintaince mode all your app and customer side website will be off. Only admin panel and seller panel will be functional')}}*</p>
            </div>
        </div>
                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('self_pickup')}}</label>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('email')}} {{\App\CentralLogics\translate('verification')}} ( Token )</label>
                                <small class="text-danger"> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            @php($dm_status=\App\Model\BusinessSetting::where('key','dm_self_registration')->first()?->value)
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('Deliverman_self_registration')}}
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="dm_self_registration_on">{{\App\CentralLogics\translate('on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                   for="dm_self_registration_off">{{\App\CentralLogics\translate('off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('Admin Logo')}}</label>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            @php($app_logo=\App\Model\BusinessSetting::where('key','app_logo')->first()->value)
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('App Logo')}}</label>
                                ...
                                <div class="custom-file">
                                    <input type="file" name="app_logo" id="customFileEg3" class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg3">{{\App\CentralLogics\translate('choose')}} {{\App\CentralLogics\translate('file')}}</label>
                                </div>

                                <div class="text-center mt-4">
                                    <img class="upload-img-view h-auto max-w-200" id="viewer_3"
                                        onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                        src="{{asset('storage/app/public/ecommerce/'.$app_logo)}}" alt="app logo image"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg2">{{\App\CentralLogics\translate('choose')}} {{\App\CentralLogics\translate('file')}}</label>
                                </div>

                                <div class="text-center mt-4">
                                    <img class="upload-img-view h-auto max-w-145" id="viewer_2"
                                        onerror="this.src='{{asset('public/assets/admin/img/160x160/img2.jpg')}}'"
                                        src="{{asset('storage/app/public/ecommerce/'.$fav_icon)}}" alt="fav_icon image"/>
                                </div>
                            </div>
                        </div>
                    </div>
