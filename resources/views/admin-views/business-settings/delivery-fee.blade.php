                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="d-flex gap-2 align-items-center my-2">
                                ...
                                <label for="shipping_by_distance_status" class="text-dark font-weight-bold mb-0">{{\App\CentralLogics\translate('delivery_charge_by_distance')}}</label>
                            </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2 align-items-center my-2">
                                    ...
                                    <label for="default_delivery_status" class="text-dark font-weight-bold mb-0">{{\App\CentralLogics\translate('default_delivery_charge')}}</label>
                                </div>
                                <div class="form-group pl-3">
