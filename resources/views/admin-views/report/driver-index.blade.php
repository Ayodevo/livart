    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                ...
                {{\App\CentralLogics\translate('driver_Report')}}
            </h2>
        </div>
                ...
                <div class="media gap-3 flex-column flex-sm-row align-items-sm-center">
                    ...
                    <div class="media-body">
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                            <div class="">
                                <h2 class="page-header-title">{{\App\CentralLogics\translate('driver')}} {{\App\CentralLogics\translate('report')}} {{\App\CentralLogics\translate('overview')}}</h2>
