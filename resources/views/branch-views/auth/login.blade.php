                    ...
                    <form id="form-id" action="{{route('branch.auth.login')}}" method="post">
                        ...
                        <div class="">
                            <div class="mb-5">
                                ...
                                <p>{{\App\CentralLogics\translate('want to login your Admin')}}
                                    ?
                                    <a href="{{route('admin.auth.login')}}">
                                        {{\App\CentralLogics\translate('Admin')}} {{\App\CentralLogics\translate('login')}}
                                    </a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @else
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a onclick="javascript:re_captcha();">
                                            <img src="{{ URL('/branch/auth/code/captcha/1') }}" class="input-field rounded" id="default_recaptcha_id" style="height: 54px">
                                            <i class="tio-refresh icon"></i>
                                        </a>
                                    </div>
                                </div>
