                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body text-capitalize d-flex flex-column">
                            ...
                            <div class="mt-2">
                                @if($order['order_type'] != 'pos')
                                    ...
                                    <select name="order_status" onchange="route_alert('{{route('branch.orders.status',['id'=>$order['id']])}}'+'&order_status='+ this.value,'{{\App\CentralLogics\translate("Change the order status to ") }}'+  this.value.replace(/_/g, ' '))" class="form-control">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h4 class="d-flex mb-0 gap-2 align-items-center"><i class="tio tio-user"></i> {{\App\CentralLogics\translate('Customer_Information')}}</h4>
                        </div>
                    ...
                    @if($order['order_type']!='self_pickup' && $order['order_type'] != 'pos')
                        <div class="card">
                            <div class="card-header">
                                <h4 class="d-flex mb-0 gap-2 align-items-center"><i class="tio tio-user"></i> {{\App\CentralLogics\translate('Delivery_Address')}}</h4>
                            </div>
